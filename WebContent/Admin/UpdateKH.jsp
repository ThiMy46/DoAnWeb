...
<body>
    ...
    <br> <br><br>
                   ...
                   <form action ="KH_Update?tgv_ma=${entry.makhoahoc}" method="post">
              <center>
              <table id="tb-giangvien" >
               <tr>
                  <td><p>Mã khóa học:</p></td>

                      <td ><input type="text" name="" value= "${entry.makhoahoc}"  disabled   /><br><span  id="errorMa" ></span>
                      </td>
                  <td><p>Tên khóa học:</p></td>

                      <td ><input type="text" name="tgv_ten" value= "${entry.tenkhoahoc}" id="formSDT" /><br><span  id="errorSDT" ></span>
                      </td>
                ...
                <tr>
                  <td><p>Số tiết:</p></td>
                      ...
                      <td  width="200"><input type="text" name="tgv_sotiet" value= "${entry.sotiet}"  id="formDiaChi" /><br><span  id="errorDiaChi" ></span>
                      </td>
                  <td><p>Học phí:</p></td>
                 
                      <td ><input type="text" name="tgv_hocphi" value= "${entry.hocphi}" placeholder="dd/mm/yyyy" id="formngaysinh" /><br><span  id="errorngaysinh" ></span>
                      </td>
