...
<body>
    ...
    <br> <br><br>
                   ...
                   <form action ="GV_Update?sgv_ma=${entry.id}" method="post">
              <center>
              <table id="tb-giangvien" >
               <tr>
                  ...
                  <td><p>Số điện thoại:</p></td>
                      ...
                      <td ><input type="text" name="sgv_sdt" value= "${entry.SDT}" id="formSDT" /><br><span  id="errorSDT" ></span>
                      </td>
                      <tr>
                 
                  <td><p>Tên giảng viên:</p></td>
                      <td><input type="text" name="sgv_ten" value= "${entry.ten}" id="formuser" /><br><span  id="errouser" ></span>
                      </td>
                  <td><p>Giới tính: </p></td>
                    <td>
                      <form>
                               <input  type="radio" name="sgv_nu"  value="false" checked/>Nam
                           <input  type="radio" name="sgv_nu" ${entry.nu}  value="true" />Nữ<br />
                           </form>
                     </td>
                </tr>
                ...
                <tr>
                  <td><p>Địa chỉ:</p></td>
                      ...
                      <td  width="200"><input type="text" name="sgv_dchi" value= "${entry.diaChi}"  id="formDiaChi" /><br><span  id="errorDiaChi" ></span>
                      </td>
                  <td><p>Ngày sinh:</p></td>
                 
                      <td ><input type="text" name="sgv_nsinh" value= "${entry.ngaysinh}" placeholder="dd/mm/yyyy" id="formngaysinh" /><br><span  id="errorngaysinh" ></span>
                      </td>
                      <tr>
                    
                  <td><p>Trình độ: </p></td>
                      <td><input type="text" name="sgv_tdo" value= "${entry.trinhdo}" id="formTrinhDo" /><br><span  id="errorTrinhDo" ></span>
                      </td>
                  <td><p>Chuyên môn: </p></td>
                      <td><input type="text" name="sgv_cmon" value= "${entry.chuyenmon}" id="formChuyenMon" /><br><span  id="errorChuyenMon" ></span>
                      </td>
                </tr>
           ...
           <center>
                ...
                <form action ="QlGiangVien" method="post">
